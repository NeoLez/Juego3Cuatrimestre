...
public class DashCard : Card {
    private DashCardInfoCameraSO _info;
    ...
    protected override void OnEnable() {
        base.OnEnable();
        GameManager.Player.GetComponent<MovementControllerTest>().Dash(Camera.main.transform.forward, _info.moveDistance, _info.time ,_info.curve);
        if (--Uses <= 0) {
